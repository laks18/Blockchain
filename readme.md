...
1.INFURA_URL- For this you will have to create an Infura account and in that copy the GORELI url from Ethereum section and assign it to INFURA_URL variable.
2.CONTRACT_ADDRESS- For this, go to the Etherscan and fetch the address of contract that is created and assign it to CONTRACT_ADDRESS variable.
3.OWNER_ADDRESS- Enter the address which is displayed in account details section in metamask.
